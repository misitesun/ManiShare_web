    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={
                    open
                        ? 'absolute left-0 top-full z-40 mt-2 max-h-64 w-full min-w-[153px] origin-top translate-y-0 scale-100 overflow-y-auto rounded-2xl border border-strong bg-canvas/95 p-2 opacity-100 shadow-xl backdrop-blur-xl transition-[opacity,transform,translate,scale] duration-150 motion-reduce:transition-none'
                        : 'pointer-events-none absolute left-0 top-full z-40 mt-2 max-h-64 w-full min-w-[153px] origin-top -translate-y-1 scale-95 overflow-y-auto rounded-2xl border border-strong bg-canvas/95 p-2 opacity-0 shadow-xl backdrop-blur-xl transition-[opacity,transform,translate,scale] duration-150 motion-reduce:transition-none'
                }
            >
                {options.map((option) => (
                    <button
                        ...
                        className={
                            value === option.value
                                ? 'flex min-h-10 w-full cursor-pointer items-center rounded-lg bg-surface-raised px-3 py-2 text-left text-label text-primary outline-none focus-visible:ring-2 focus-visible:ring-focus'
                                : 'flex min-h-10 w-full cursor-pointer items-center rounded-lg px-3 py-2 text-left text-label text-primary outline-none hover:bg-surface-hover focus-visible:bg-surface-hover focus-visible:ring-2 focus-visible:ring-focus'
                        }
                        onClick={(): void => {
