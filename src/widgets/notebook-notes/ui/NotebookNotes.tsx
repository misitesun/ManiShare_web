...
import type { NotebookGroup, NotebookRecord } from '../../../entities/notebook'
...
export interface NotebookNotesProps {
    readonly groups: readonly NotebookGroup[]
}

export function NotebookNotes({ groups }: NotebookNotesProps): ReactElement {
        ...
        <div>
            <div className="space-y-4">
                {visibleGroups.length === 0 ? (
                    <p className="py-10 text-center text-body text-secondary">暂无笔记</p>
                ) : null}
